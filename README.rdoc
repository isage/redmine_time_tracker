== WARNING: this is unofficial fork
...
* (NEW) Multiple time trackers and fast switching between them
...
The newest version is always at {GitHub}[http://github.com/isage/redmine_time_tracker].
